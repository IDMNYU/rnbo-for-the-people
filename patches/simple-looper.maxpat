...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 262.0, 207.0, 182.0, 83.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 262.0, 111.0, 95.0, 22.0 ],
					"text" : "getattr envelope"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 262.0, 160.0, 109.0, 22.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 245.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 111.0, 43.0, 22.0 ],
					"text" : "run $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 68.0, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.0, 506.0, 79.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 202.0, 546.0, 176.0, 23.0 ],
...
,
									"text" : "param envelope @min 0 @max 1",
									"varname" : "envelope"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 202.0, 467.0, 122.0, 23.0 ],
									"rnbo_classname" : "rampsmooth~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "rampsmooth~_obj-13",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 202.0, 428.0, 29.5, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 202.0, 389.0, 33.0, 23.0 ],
									"rnbo_classname" : "abs~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "abs~_obj-11",
									"text" : "abs~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 99.0, 546.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 125.0, 246.0, 50.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 99.0, 198.0, 42.0, 23.0 ],
									"rnbo_classname" : "sel",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 154.0, 34.0, 23.0 ],
									"rnbo_classname" : ">",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 99.0, 293.0, 136.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 353.0, 100.0, 173.0, 23.0 ],
...
,
									"text" : "buffer~ sample @file jongly.wav"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 99.0, 100.0, 196.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"enum" : "",
...
,
					"patching_rect" : [ 89.0, 160.0, 149.0, 22.0 ],
					"rnboattrcache" : 					{
						"run" : 						{
							"label" : "run",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "47eec2db-5db4-11f0-82db-a2db61054e31"
					}
,
					"snapshot" : 					{
...
,
									"fileref" : 									{
										"name" : "simple-looper",
										"filename" : "simple-looper.maxsnap",
										"filepath" : "~/Documents/Max 9/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "a63d54a53c92e366599e3f22066b2aef"
									}
...
,
		"dependency_cache" : [ 			{
				"name" : "jongly.wav",
				"bootpath" : "~/nyu/rnbo-for-the-people/patches",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
				"name" : "simple-looper.maxsnap",
